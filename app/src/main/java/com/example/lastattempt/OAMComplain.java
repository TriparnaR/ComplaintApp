...
public class OAMComplain extends AppCompatActivity {
    private EditText SubjectEdt, DescriptionEdt;

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_oamcomplain);
        SubjectEdt = findViewById(R.id.editTextText);
        DescriptionEdt = findViewById(R.id.editText6);
        Button sendbtn = findViewById(R.id.button4);
        Button confirmbtn = findViewById(R.id.button5);
        ...
        sendbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                data.put("Subject", SubjectEdt.getText().toString());
                data.put("Description", DescriptionEdt.getText().toString());

                // Get a reference to the Firestore collection
                CollectionReference complainCollection = FirebaseFirestore.getInstance().collection("Operations And Maintenance Complain");
